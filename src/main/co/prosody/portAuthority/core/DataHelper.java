...
public class DataHelper {
	...
	public static void addLocationToConversation(PaInputData data, SkillContext skillContext) throws InvalidInputException {
	...
	public static void addRouteToConversation(PaInputData data, SkillContext skillContext) throws InvalidInputException {
	...
	public static void addDirectionToConversation(PaInputData data, SkillContext skillContext) throws InvalidInputException {
		try {
			String direction = data.getRawDirection();
	...
	public static Stop getNearestStop(final PaInputData data, SkillContext skillContext) throws InvalidInputException{
		try{
			...
			throw new InvalidInputException("JSONException in API", jsonE,
					"I'm Having Technical Difficulties. I will alert the technical staff. Please try again later.");
		} catch (IOException ioE) {
			throw new InvalidInputException("Cannot reach one of the APIs", ioE,			
					"I'm Having Technical Difficulties. I will alert the technical staff. Please try again later.");
