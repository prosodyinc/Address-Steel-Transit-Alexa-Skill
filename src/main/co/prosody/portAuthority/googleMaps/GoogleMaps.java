...
public class GoogleMaps {
	 ...
	 */
	public static Stop findNearestStop(Location source, List<Stop> stops) throws InvalidInputException, IOException, JSONException {
		return NearestStopLocator.findNearestStop(source, stops);
	}
